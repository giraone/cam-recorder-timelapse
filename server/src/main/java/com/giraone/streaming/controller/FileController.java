...
public class FileController {
    ...
    @PostMapping(value = "camera-images/{filename}", consumes = {MediaType.IMAGE_JPEG_VALUE, MediaType.IMAGE_PNG_VALUE})
    ...
    @SuppressWarnings("unused")
    @GetMapping("camera-images/{filename}")
