package com.giraone.camera.views.videos;
...
import com.giraone.camera.views.components.GridFileInfo;
import com.giraone.camera.views.components.TextPromptDialog;
...
public class VideosView extends VerticalLayout {
    ...
    private void activation(boolean selected) {
        ...
        LOGGER.debug("activation selected={} itemsSize={} totalCount={}", selected, itemsSize, totalCount);
